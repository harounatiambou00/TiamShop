...
@ProductId  NVARCHAR(MAX), @ProductReference nvarchar(100), @ProductName nvarchar(100),@ProductDescription nvarchar(max), @ProductPrice MONEY, @ProductQuantity int, @ProductPrincipalImageId bigint, @Waranty NVARCHAR(50), @Color NVARCHAR(50), @BrandId int, @SubCategoryId int
AS
