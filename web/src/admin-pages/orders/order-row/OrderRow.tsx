    ...
    <TableRow className={index % 2 === 0 ? "bg-inherit" : "bg-white"}>
      ...
      <TableCell className="">
        {order.deliveredAt !== null && (
          <Button
            variant="contained"
            className="bg-green-100 h-7 text-green-800 rounded-full normal-case cursor-default"
            disableElevation
            disableRipple
          >
            <span className="font-kanit font-light bg-green-100 text-green-800 rounded-full drop-shadow-sm align-middle">
              <BsFillPatchCheckFill className="inline mr-1" />
              Livrée
            </span>
          </Button>
        ...
        {order.deliveryId === null && (
          <Button
            variant="contained"
            className="bg-gray-200 h-7 text-black rounded-full normal-case font-light cursor-default px-2"
            disableElevation
            disableRipple
          >
            <span className="font-kanit bg-gray-200 text-black rounded-full drop-shadow-sm align-middle ">
              Non assignée
            </span>
          </Button>
        )}
